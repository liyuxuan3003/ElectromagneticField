...
\begin{Equation}&[2]
    ...
    \qquad\qquad\qquad
\end{Equation}
由于我们考虑的是平面电磁波，而平面波仅沿一个方向传播，不妨设其沿$z$轴方向传播，那么电场强度$\vb*{\dot{E}}$和磁场强度$\vb*{\dot{H}}$都只是坐标$z$的函数，而与坐标$x,y$无关，\xrefpeq{2}即简化为
\begin{Equation}&[3]
...
\begin{Align}[16pt]
    &\dv[2]{\dot{E_x}}{z}+k\dot{E_x}=0&
    &\dv[2]{\dot{H_x}}{z}+k\dot{E_x}=0\xlabelpeq{7}\\
    &\dv[2]{\dot{E_y}}{z}+k\dot{E_y}=0&
    &\dv[2]{\dot{H_y}}{z}+k\dot{E_y}=0\xlabelpeq{8}\\
    &\dv[2]{\dot{E_z}}{z}+k\dot{E_z}=0&
    &\dv[2]{\dot{H_z}}{z}+k\dot{E_z}=0\xlabelpeq{9}
\end{Align}
