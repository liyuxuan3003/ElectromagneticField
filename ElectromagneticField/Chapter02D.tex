...
\begin{Equation}[电本构]
    \vb*{D}=\varepsilon_0\vb*{E}+\vb*{P}=\varepsilon_0\vb*{E}+\varepsilon_0\chi_\text{e}\vb*{E}=\varepsilon_0(1+\chi_\text{e})\vb*{P}=\varepsilon_0\varepsilon_\text{r}\vb*{P}=\varepsilon\vb*{E}
\end{Equation}
...
\begin{Equation}[磁介质的相对磁导率]
    \qquad\qquad
    \vb*{B}=\mu_0\vb*{H}+\mu_0\vb*{M}=\mu_0\vb*{H}+\mu_0\chi_\text{m}\vb*{H}=\mu_0(1+\chi_\text{m})\vb*{H}=\mu_0\mu_\text{r}\vb*{H}=\mu\vb*{H}
    \qquad\qquad
\end{Equation}
